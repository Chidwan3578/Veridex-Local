...
import { RolesBackground } from "./roles-background"
    ...
    <section className="relative border-t border-border/50 px-6 py-24 overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-7xl pointer-events-none">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          {/* Left Column: Spline Scene */}
          <div className="relative h-[400px] md:h-[600px] w-full overflow-hidden rounded-3xl border border-white/5 bg-black/20 backdrop-blur-sm pointer-events-auto">
            <Suspense fallback={<div className="flex h-full w-full items-center justify-center text-white/20 animate-pulse">Initializing 3D...</div>}>
              <Spline
                scene="https://prod.spline.design/6cukjzjXsD-ACz6E/scene.splinecode"
              />
            </Suspense>
          </div>
          ...
          <div className="flex flex-col gap-8">
            {/* Candidate Card */}
            <div className="group relative flex flex-col gap-6 overflow-hidden rounded-3xl border border-white/10 bg-card/30 p-8 shadow-2xl backdrop-blur-2xl transition-all hover:bg-card/50 hover:border-primary/30 hover:scale-[1.01] pointer-events-auto">
            ...
            {/* Recruiter Card */}
            <div className="group relative flex flex-col gap-6 overflow-hidden rounded-3xl border border-white/10 bg-card/30 p-8 shadow-2xl backdrop-blur-2xl transition-all hover:bg-card/50 hover:border-accent/30 hover:scale-[1.01] pointer-events-auto">
